...
def get_snapshot_usages_project(meta, project_id):
    ...
    snapshots_q = select(
        ...
        whereclause=and_(
            snapshots_t.c.deleted == false(), snapshots_t.c.project_id == project_id
        ),
    )
...
def get_volume_usages_project(meta, project_id):
    ...
    volumes_q = select(
        ...
        whereclause=and_(
            volumes_t.c.deleted == false(), volumes_t.c.project_id == project_id
        ),
    )
...
def main():
    ...
    quota_usages = {}
    for resource, count in get_quota_usages_project(cinder_metadata, args.project_id):
    ...
    for _, size, type_id in get_volume_usages_project(cinder_metadata, args.project_id):
    ...
    # prepare the output
    ptable = PrettyTable(["Project ID", "Resource", "Quota -> Real", "Sync Status"])
